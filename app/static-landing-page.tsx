  ...
  return (
    <>
      <Row columns={[6, 8, 12, 12]} sx={{ mb: [4, 4, 8, 8] }}>
        <Column start={[1, 1, 2, 2]} width={[6, 6, 5, 5]} sx={{ mb: 8 }}>
        ...
        <Column
          ...
          sx={{ mb: [0, 0, 8, 8] }}
        >
          <Box sx={{ variant: 'text.monoCaps', mb: 3 }}>About</Box>
          <Box sx={{ mb: 7 }}>
          ...
          <Box>
            We are now accepting pre-submissions. To submit your CDR preprint
            article and/or data, email{' '}
